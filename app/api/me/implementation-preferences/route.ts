...
const preferenceKeys = ["appointmentsOpen", "managementOpen", "sharingOpen", "filesOpen", "dnsOpen", "tasksOpen", "dossierOpen", "implementationDataOpen", "dashboardPlanningOpen", "dashboardDealsOpen"] as const;

...
const preferenceKeys = ["appointmentsOpen", "managementOpen", "sharingOpen", "filesOpen", "dnsOpen", "tasksOpen", "dossierOpen", "implementationDataOpen", "dashboardPlanningOpen", "dashboardDealsOpen", "dashboardCustomerActivitiesOpen"] as const;

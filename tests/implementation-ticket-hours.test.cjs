...
test('ticket hours use the aggregate include, preserve zero and reject missing or invalid hours',async()=>{
 ...
 new Function('module','exports','require',code)(module,module.exports,()=>({getSmartTradePullHeaders:()=>({}),fetchWithSmartTradeTimeout:async(...args)=>{calls.push(args);return {ok,json:async()=>({data:{workedHours:raw}})};}}));
